 ...
 */
void Basketgame::initialiserEtatPartie()
{
    estVainqueur     = false;
    estEquipeRouge   = true;
    nbPionsJoues     = 0;
...
void Basketgame::placerPion(int colonne)
{
    int ligne = 0;
